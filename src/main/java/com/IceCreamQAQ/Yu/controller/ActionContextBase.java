...
import com.IceCreamQAQ.Yu.inject.ActionContextInject;
...
public abstract class ActionContextBase {
    ...
    public ActionContextBase(String[] path){
        contextInject=new ActionContextInject();
        contextInject.putInjectObj(ActionContextBase.class.getName(),"",this);
