        ...
        }
        {
            ...
            for (int i = 0; i < paras.length; i++) {
                ...
                if (inject != null) {
                    ...
                    mv.visitMethodInsn(INVOKEVIRTUAL, ActionContextBase.class.getName().replace(".","/"), "injectInject", "(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;", false);
                }
