...
public class YuHook_Old {
    ...
    static class MethodInfo {
        ...
        public MethodInfo(String name, String desc, MethodNode newNode, MethodNode oldNode, String paraName, boolean instanceMode) {
            this.name = name;
            this.desc = desc;
...
//        reader.accept(node, 0);
        ...
        for (val method : node.methods) {
            ...
            if (h || mh || ah) {
                ...
                val mi = new MethodInfo(method.name, method.desc, nmn, method, mpn, instanceMode);
                newMethods.add(mi);
