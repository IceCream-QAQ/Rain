...
//
        test.onPrivateMessage(10006,2667497585L,"菜单",0);

        test.onGroupMessage(10006, 101471173, 2667497585L, null, "菜单", 0);
        test.onGroupMessage(10006, 101471173, 2667497585L, null, "a b c 菜单2", 0);

        test.groupAdminAdd(10006,101471173,2667497585L);
